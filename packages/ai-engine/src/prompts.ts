...
export function generateAnalysisPrompt(code: string, context: AIContext): string {
...
export function generateSuggestionPrompt(code: string, issue: string): string {
...
export function generateRefactoringPrompt(code: string, context: AIContext): string {
...
export function generateDocumentationPrompt(code: string, context: AIContext): string {
